 ...
 */
class Module extends \RequirementsManager\Entity\Module implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'RequirementsManager\\Entity\\Module' . "\0" . 'id', '' . "\0" . 'RequirementsManager\\Entity\\Module' . "\0" . 'title', '' . "\0" . 'RequirementsManager\\Entity\\Module' . "\0" . 'project_id', '' . "\0" . 'RequirementsManager\\Entity\\Module' . "\0" . 'user_id', '' . "\0" . 'RequirementsManager\\Entity\\Module' . "\0" . 'description', '' . "\0" . 'RequirementsManager\\Entity\\Module' . "\0" . 'version', '' . "\0" . 'RequirementsManager\\Entity\\Module' . "\0" . 'artifacts', '' . "\0" . 'RequirementsManager\\Entity\\Module' . "\0" . 'soft_delete');
        }
